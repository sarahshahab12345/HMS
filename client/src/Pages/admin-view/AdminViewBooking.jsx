          ...
          <table className="min-w-full bg-white border border-gray-300 rounded-md shadow-md">
            <thead className="bg-gray-200">
              <tr>
                ...
                <th className="p-4 border border-gray-300">Room Number</th>
            ...
            <tbody>
              {bookings.map((booking, index) => (
                ...
                >
                  ...
                  <td className="p-4 border border-gray-300">{booking.guestName}</td>
                  <td className="p-4 border border-gray-300">{booking.roomNumber}</td>
                  <td className="p-4 border border-gray-300">{booking.bookingPlatform}</td>
                  <td className="p-4 border border-gray-300">{booking.bookingStartDate}</td>
                  <td className="p-4 border border-gray-300">{booking.bookingEndDate}</td>
